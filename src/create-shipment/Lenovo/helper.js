...
async function payloadToAddTrakingNotesToWT(housebill, shipmentId) {
  try {
    const xmlData = `<?xml version="1.0"?>\n<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">\n<soap:Header>\n <AuthHeader\n xmlns="http://tempuri.org/">\n <UserName>${process.env.wt_soap_username}</UserName>\n <Password>${process.env.wt_soap_password}</Password>\n </AuthHeader>\n </soap:Header>\n <soap:Body>\n <WriteTrackingNote\n xmlns="http://tempuri.org/">\n <HandlingStation/>\n <HouseBill>${housebill}</HouseBill>\n <TrackingNotes>\n <TrackingNotes>\n <TrackingNoteMessage>&lt;a href="${process.env.CW_SHIPMENT_DETAILS}?QuickViewNumber=${shipmentId}" target="_blank"&gt;${shipmentId}&lt;/a&gt;</TrackingNoteMessage>\n </TrackingNotes>\n </TrackingNotes>\n </WriteTrackingNote>\n </soap:Body>\n</soap:Envelope>\n`;
    return xmlData;
  } catch (error) {
